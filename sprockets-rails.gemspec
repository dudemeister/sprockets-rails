...
Gem::Specification.new do |s|
  ...
  s.authors = ["Ali Jelveh"]
  s.date = %q{2011-03-30}
  s.description = %q{sprockets-rails containing changes to allow sections and rails3 compatability}
  s.email = %q{jelveh@web.de}
  s.extra_rdoc_files = [
    "README.markdown"
  ]
  s.files = [
  ...
  s.homepage = %q{http://github.com/dudemeister/sprockets-rails}
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
